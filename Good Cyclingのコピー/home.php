...
:</span>
      ...
      <div class="fix-sp">
        <div class="apple-sp">
          <img src="<?php echo get_template_directory_uri(); ?>/img/アプリアイコン.png" alt="アプリアイコン" />
        </div>
        <p class="arrow-sp">↑↑↑↑</p>
...
<?php foreach($posts as $post): ?>
  ...
  <?php setup_postdata($post); ?>
          <div class="voice-content">
            <a href="<?php the_permalink(); ?>"> <div class="image">image</div></a>
            <div>
          ...
          <div>
            ...
            <div class="accordion">
              <div class="faq">
                ...
                <label class="question" for="faq01"
                  ><span>Q</span
                  >シェアサイクルの利用方法を教えてください。</label
                >
                <div class="anser">
                  <div>
                    <span>A</span>
              ...
              <div class="faq">
                ...
                <label class="question" for="faq02"
                  ><span>Q</span>料金体系はどのようになっていますか？</label
                >
                <div class="anser">
                  <div>
                    <span>A</span>
              ...
              <div class="faq">
                ...
                <label class="question" for="faq03"
                  ><span>Q</span
                  >どこで自転車を借りたり返却したりできますか？</label
                >
                <div class="anser">
                  <div>
                    <span>A</span>
